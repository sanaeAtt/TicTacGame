...
public class game extends AppCompatActivity {
    ...
    public void onClick(View view) {
        ...
        if (player1) {
            ...
            ((ImageView) view).setImageResource(choixSecndPlayer);
        }
        round++;
        if (checkWiner()) {
            if (player1) {
